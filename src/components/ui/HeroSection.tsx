function HeroSection() {
  return (
    <>
      <div className="heroSection flex flex-col lg:flex-row items-center justify-center gap-10 lg:gap-14.75 px-28.5 py-14 lg:py-14.75 ">
        {/* Section1 */}
        <div className="flex flex-col lg:w-86.75 lg:h-33.5 justify-center gap-4 lg:gap-6">
          <h1 className="text-center lg:text-right text-headline-1 text-brown-600">
            Stay Informed,<br /> Stay Inspired</h1>
          <p className="text-center lg:text-right text-body-1 text-brown-400">Discover a World of Knowledge at Your Fingertips. Your Daily Dose of Inspiration and Information.</p>
        </div>
        {/* Section2 */}
        <img
